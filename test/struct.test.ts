...
test("Test StrutBuilder class to build struct objects", () => {
    const struct = StructBuilder.new()
        ...
        .varUInt8("row_uint8")
        .varInt32("row_int32")
        .varInt32LE("row_int32le")
        .varUInt32("row_uint32")
        .varUInt32LE("row_uint32le")
        .varInt64("row_int64")
        .varInt64LE("row_int64le")
        .varUInt64("row_uint64")
        .varUInt64LE("row_uint64le")
        .varFloat("row_float")
        .varFloatLE("row_floatle")
        .varDouble("row_double")
        .varDoubleLE("row_doublele")
        .varFLString("row_flstring", 36)
        .varPString("row_pstring", Types.Int32)
        .build<data>();
